  ...
  >
    Sipas Pozitës
            ...
            {selectedPunetoriId && (
              <div className="border-t border-gray-200 pt-4">
                ...
                <form onSubmit={handleUpdatePunetori} className="mt-4">
                  ...
                  <button type="submit" className="mt-4 w-full inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Përmirëso Punëtorin</button>
                </form>
              </div>
            )}
            <form onSubmit={handleCreatePunetori}>
              ...
              <button type="submit" className="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mb-14">Krijo</button>
            </form>
          </div>
        </div>
      </div>
