...
namespace InpositionLibrary.Migrations
{
    ...
    [Migration("20240716215805_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InpositionLibrary.Models.LoginModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InpositionLibrary.Models.Punetori", b =>
                {
                    ...
                    b.HasIndex("BiblotekaId");

                    b.ToTable("Punetori");
                });

            modelBuilder.Entity("InpositionLibrary.Models.RefreshTokenModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f03a2f08-38c7-4aa0-82e6-31575871f38e",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "608738b4-1462-4c4f-914b-a550e5c6efdb",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
