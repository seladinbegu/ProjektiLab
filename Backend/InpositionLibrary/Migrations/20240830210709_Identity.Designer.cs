...
namespace InpositionLibrary.Migrations
{
    ...
    [Migration("20240830210709_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InpositionLibrary.Models.RefreshToken", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "8fc2417c-180e-4082-9681-49723bd2fd83",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "666226ce-cb4e-4762-822c-42baa984708c",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InpositionLibrary.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
